...
def generate_sample(noise_prop, seed = 999,size = 28, var = 0.15,
                    noise_indx = False, order = None,n=None, Nclass = 2):
    """Generates samples.
  ...
  """
    ...
    if(n is not None and order is not None):
        print("Error: n and order cannot be input at the same time" +
