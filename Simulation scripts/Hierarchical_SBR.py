...
for j in range(NREPS):
    for a_indx, a_val in enumerate(alphas):
        ...
        # 7. Get predictions 
        preds = (Parallel(n_jobs=10)(delayed(get_predictions_hierarchical)(
                                            model= model_tvgg,
        ...
        #for i in range(len(preds)):
            ...
            trues_list.append(label.numpy())
            preds_list.append(y_pred.numpy())
            probs_list.append(probas.numpy())
...
joblib.dump(env_vars, '/home/sofia/Candu_postdoc/InformedMlCv/environments/SBR_Hierarchical_noise2.pkl')
